...
If ($Help) {
    ...
    * WSUS server information if you want to use it"
    ...
    if ($ping_google) {
        Write-Host "Internet detected." -ForegroundColor Green
        ...
        Write-Host "Unable to ping Google.com!"
        Write-Host "Unfortunately, script needs internet to download required files." -ForegroundColor Yellow
